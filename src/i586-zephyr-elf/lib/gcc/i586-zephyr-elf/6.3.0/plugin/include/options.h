...
enum opt_code
{
  ...
  OPT_march_ = 1202,                         /* -march= */
  OPT_masm_ = 1203,                          /* -masm= */
  OPT_mavx = 1204,                           /* -mavx */
  OPT_mavx2 = 1205,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1206,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1207,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bw = 1208,                      /* -mavx512bw */
  OPT_mavx512cd = 1209,                      /* -mavx512cd */
  OPT_mavx512dq = 1210,                      /* -mavx512dq */
  OPT_mavx512er = 1211,                      /* -mavx512er */
  OPT_mavx512f = 1212,                       /* -mavx512f */
  OPT_mavx512ifma = 1213,                    /* -mavx512ifma */
  OPT_mavx512pf = 1214,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1215,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1216,                      /* -mavx512vl */
  OPT_mbmi = 1217,                           /* -mbmi */
  OPT_mbmi2 = 1218,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1219,                  /* -mbranch-cost= */
  OPT_mcld = 1220,                           /* -mcld */
  OPT_mclflushopt = 1221,                    /* -mclflushopt */
  OPT_mclwb = 1222,                          /* -mclwb */
  OPT_mclzero = 1223,                        /* -mclzero */
  OPT_mcmodel_ = 1224,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1225, */                    /* -mcpu= */
  OPT_mcrc32 = 1226,                         /* -mcrc32 */
  OPT_mcx16 = 1227,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1228,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1229,            /* -mdump-tune-features */
  OPT_mf16c = 1230,                          /* -mf16c */
  OPT_mfancy_math_387 = 1231,                /* -mfancy-math-387 */
  OPT_mfentry = 1232,                        /* -mfentry */
  OPT_mfma = 1233,                           /* -mfma */
  OPT_mfma4 = 1234,                          /* -mfma4 */
  OPT_mforce_drap = 1235,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1236,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1237,                       /* -mfpmath= */
  OPT_mfsgsbase = 1238,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1239, */              /* -mfused-madd */
  OPT_mfxsr = 1240,                          /* -mfxsr */
  OPT_mhard_float = 1241,                    /* -mhard-float */
  OPT_mhle = 1242,                           /* -mhle */
  OPT_miamcu = 1243,                         /* -miamcu */
  OPT_mieee_fp = 1244,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1245,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1246,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1247,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1248, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1249,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1250,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1251,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1252,                /* -mlong-double-80 */
  OPT_mlwp = 1253,                           /* -mlwp */
  OPT_mlzcnt = 1254,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1255,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1256,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1257,                  /* -mmitigate-rop */
  OPT_mmmx = 1258,                           /* -mmmx */
  OPT_mmovbe = 1259,                         /* -mmovbe */
  OPT_mmpx = 1260,                           /* -mmpx */
  OPT_mms_bitfields = 1261,                  /* -mms-bitfields */
  OPT_mmwaitx = 1262,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1263,            /* -mno-align-stringops */
  OPT_mno_default = 1264,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1265,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1266,                  /* -mno-push-args */
  OPT_mno_red_zone = 1267,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1268,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1269,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1270,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1271,                          /* -mpc32 */
  OPT_mpc64 = 1272,                          /* -mpc64 */
  OPT_mpc80 = 1273,                          /* -mpc80 */
  OPT_mpclmul = 1274,                        /* -mpclmul */
  OPT_mpcommit = 1275,                       /* -mpcommit */
  OPT_mpku = 1276,                           /* -mpku */
  OPT_mpopcnt = 1277,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1278,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1279,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1280,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1281,                        /* -mprfchw */
  OPT_mpush_args = 1282,                     /* -mpush-args */
  OPT_mrdrnd = 1283,                         /* -mrdrnd */
  OPT_mrdseed = 1284,                        /* -mrdseed */
  OPT_mrecip = 1285,                         /* -mrecip */
  OPT_mrecip_ = 1286,                        /* -mrecip= */
  OPT_mrecord_mcount = 1287,                 /* -mrecord-mcount */
  OPT_mred_zone = 1288,                      /* -mred-zone */
  OPT_mregparm_ = 1289,                      /* -mregparm= */
  OPT_mrtd = 1290,                           /* -mrtd */
  OPT_mrtm = 1291,                           /* -mrtm */
  OPT_msahf = 1292,                          /* -msahf */
  OPT_msha = 1293,                           /* -msha */
  OPT_mskip_rax_setup = 1294,                /* -mskip-rax-setup */
  OPT_msoft_float = 1295,                    /* -msoft-float */
  OPT_msse = 1296,                           /* -msse */
  OPT_msse2 = 1297,                          /* -msse2 */
  OPT_msse2avx = 1298,                       /* -msse2avx */
  OPT_msse3 = 1299,                          /* -msse3 */
  OPT_msse4 = 1300,                          /* -msse4 */
  OPT_msse4_1 = 1301,                        /* -msse4.1 */
  OPT_msse4_2 = 1302,                        /* -msse4.2 */
  OPT_msse4a = 1303,                         /* -msse4a */
  /* OPT_msse5 = 1304, */                    /* -msse5 */
  OPT_msseregparm = 1305,                    /* -msseregparm */
  OPT_mssse3 = 1306,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1307,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1308,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1309,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1310,            /* -mstringop-strategy= */
  OPT_mstv = 1311,                           /* -mstv */
  OPT_mtbm = 1312,                           /* -mtbm */
  OPT_mtls_dialect_ = 1313,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1314,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1315,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1316,                         /* -mtune= */
  OPT_mveclibabi_ = 1317,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1318,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1319,                    /* -mvzeroupper */
  OPT_mx32 = 1320,                           /* -mx32 */
  OPT_mxop = 1321,                           /* -mxop */
  OPT_mxsave = 1322,                         /* -mxsave */
  OPT_mxsavec = 1323,                        /* -mxsavec */
  OPT_mxsaveopt = 1324,                      /* -mxsaveopt */
  OPT_mxsaves = 1325,                        /* -mxsaves */
  OPT_n = 1326,                              /* -n */
  ...
  OPT_static_libgcj = 1369,                  /* -static-libgcj */
  ...
  /* OPT_std_c1x = 1387, */                  /* -std=c1x */
  /* OPT_std_c89 = 1388, */                  /* -std=c89 */
  OPT_std_c90 = 1389,                        /* -std=c90 */
  OPT_std_c99 = 1390,                        /* -std=c99 */
  /* OPT_std_c9x = 1391, */                  /* -std=c9x */
  OPT_std_f2003 = 1392,                      /* -std=f2003 */
  OPT_std_f2008 = 1393,                      /* -std=f2008 */
  OPT_std_f2008ts = 1394,                    /* -std=f2008ts */
  OPT_std_f95 = 1395,                        /* -std=f95 */
  OPT_std_gnu = 1396,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1397, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1398, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1399,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1400,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1401, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1402, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1403,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1404,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1405,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1406, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1407, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1408,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1409,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1410, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1411, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1412,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1413, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1414, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1415, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1416,                     /* -std=legacy */
  OPT_symbolic = 1417,                       /* -symbolic */
  OPT_t = 1418,                              /* -t */
  OPT_time = 1419,                           /* -time */
  OPT_time_ = 1420,                          /* -time= */
  OPT_traditional = 1421,                    /* -traditional */
  OPT_traditional_cpp = 1422,                /* -traditional-cpp */
  OPT_trigraphs = 1423,                      /* -trigraphs */
  OPT_u = 1424,                              /* -u */
  OPT_undef = 1425,                          /* -undef */
  OPT_v = 1426,                              /* -v */
  OPT_version = 1427,                        /* -version */
  OPT_w = 1428,                              /* -w */
  OPT_wrapper = 1429,                        /* -wrapper */
  OPT_x = 1430,                              /* -x */
  OPT_z = 1431,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
